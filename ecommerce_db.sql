...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 21 Okt 2021 pada 03.59
...
(1, 'Side Chair', 11112, '', '', '', 890000, 5, 5, '2021-10-19 11:11:57', '2021-10-19 11:11:57'),
(2, 'Arm Chair', 11112, '', '', '', 500000, 5, 5, '2021-10-19 11:13:07', '2021-10-19 11:13:07'),
(3, 'Dining Chair', 11112, '', '', '', 600000, 6, 4, '2021-10-19 11:13:07', '2021-10-19 11:13:07'),
(4, 'Bar Table', 11113, '', '', '', 1200000, 8, 6, '2021-10-19 11:13:07', '2021-10-19 11:13:07'),
(5, 'Coffe Table', 11113, '', '', '', 1000000, 9, 3, '2021-10-19 11:13:07', '2021-10-19 11:13:07'),
(6, 'Lemari Pakaian', 11114, '', '', '', 2000000, 20, 3, '2021-10-19 11:13:07', '2021-10-19 11:13:07'),
(7, 'Lemari Document', 11114, '', '', '', 1800000, 17, 4, '2021-10-19 11:13:07', '2021-10-19 11:13:07');
...
--
ALTER TABLE `barang`
  MODIFY `idbarang` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `pelanggan`
  MODIFY `idpelanggan` int(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `penjualan`
--
ALTER TABLE `penjualan`
  MODIFY `idpenjualan` int(20) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `detail_penjualan`
  ...
  ADD CONSTRAINT `detail_penjualan_ibfk_3` FOREIGN KEY (`idpenjualan`) REFERENCES `penjualan` (`idpenjualan`);
...
--
ALTER TABLE `pelanggan`
  ADD CONSTRAINT `pelanggan_ibfk_1` FOREIGN KEY (`idkota`) REFERENCES `kota` (`id_kota`);

--
-- Ketidakleluasaan untuk tabel `penjualan`
--
ALTER TABLE `penjualan`
  ADD CONSTRAINT `penjualan_ibfk_2` FOREIGN KEY (`idkota_kirim`) REFERENCES `kota` (`id_kota`),
...
ALTER TABLE `status_penjualan`
  ...
  ADD CONSTRAINT `status_penjualan_ibfk_2` FOREIGN KEY (`idpenjualan`) REFERENCES `penjualan` (`idpenjualan`),
